...
- Understanding corporate training structure  
- Git and GitHub fundamentals  
- Basics of Java programming  
- Transition from Java to C#  
- Compiler vs Interpreter concepts  
- Initial exposure to .NET ecosystem  

---

### 🎯 Week 1 – Skill Progress
...
### 🎯 Week 2 – Skill Progress

| Skill | Status |
|-----|-------|
| C# Advanced Basics | 🟡 In Progress |
